module @module {
  func.func @sdpa1(%arg0: !torch.vtensor<[1,1,32,128],f16>, %arg1: !torch.vtensor<[1,1,32,128],f16>, %arg2: !torch.vtensor<[1,1,32,128],f16>, %arg3: !torch.tensor<[1,4096,32,128],f16>, %arg4: !torch.tensor<[1,4096,32,128],f16>) -> !torch.vtensor<[1,1,4096],f16> attributes {torch.assume_strict_symbolic_shapes} {
    ...
    %13:2 = torch.operator "torch.aten._scaled_dot_product_flash_attention_for_cpu"(%8, %10, %12, %float0.000000e00, %false_28, %none, %none_29) : (!torch.vtensor<[1,32,1,128],f16>, !torch.vtensor<[1,32,1,128],f16>, !torch.vtensor<[1,32,1,128],f16>, !torch.float, !torch.bool, !torch.none, !torch.none) -> (!torch.vtensor<[1,32,1,128],f16>, !torch.vtensor<[1,32,1],f32>) 
    %int1_30 = torch.constant.int 1
    %int2_31 = torch.constant.int 2
    %14 = torch.aten.transpose.int %13#0, %int1_30, %int2_31 : !torch.vtensor<[1,32,1,128],f16>, !torch.int, !torch.int -> !torch.vtensor<[1,1,32,128],f16>
    %int1_32 = torch.constant.int 1
    %int1_33 = torch.constant.int 1
    %int-1 = torch.constant.int -1
    %15 = torch.prim.ListConstruct %int1_32, %int1_33, %int-1 : (!torch.int, !torch.int, !torch.int) -> !torch.list<int>
